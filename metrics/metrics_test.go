...
func TestHistogram(t *testing.T) {
	...
	histogram := kitprometheus.NewHistogramFrom(stdprometheus.HistogramOpts{
		Namespace: namespace,
		Subsystem: subsystem,
		Name:      name,
...
func TestNewPacketDBPool(t *testing.T) {
	big1 := big.NewInt(33)
	big2 := big.NewInt(22)
	big3 := big.NewInt(11)
	big1.Add(big1, big3)
	big1.Sub(big1, big2)
	big1.Add(big1, &big.Int{})
	big1.Mul(big1, big.NewInt(-1))
	big1.Mul(big1, big.NewInt(-1))
	fmt.Print(big1.String())
}
